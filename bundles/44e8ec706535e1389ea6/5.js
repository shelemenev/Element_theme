...
/* harmony import */ var file_saver__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(432);
/* harmony import */ var file_saver__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(file_saver__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(83);
...
/* harmony import */ var _utils_MegolmExportEncryption__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(641);
...
class ExportE2eKeysDialog extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  constructor(props) {
    super(props);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "unmounted", false);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "passphrase1", /*#__PURE__*/Object(react__WEBPACK_IMPORTED_MODULE_2__["createRef"])());

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "passphrase2", /*#__PURE__*/Object(react__WEBPACK_IMPORTED_MODULE_2__["createRef"])());

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "onPassphraseFormSubmit", ev => {
      ev.preventDefault();
      const passphrase = this.passphrase1.current.value;

      if (passphrase !== this.passphrase2.current.value) {
        this.setState({
          errStr: Object(_languageHandler__WEBPACK_IMPORTED_MODULE_4__[/* _t */ "a"])('Passphrases must match')
        });
        return false;
      }
      ...
      if (!passphrase) {
        this.setState({
          errStr: Object(_languageHandler__WEBPACK_IMPORTED_MODULE_4__[/* _t */ "a"])('Passphrase must not be empty')
        });
        return false;
      }
  ...
  startExport(passphrase) {
    ...
    Promise.resolve().then(() => {
      ...
      return _utils_MegolmExportEncryption__WEBPACK_IMPORTED_MODULE_5__[/* encryptMegolmKeyFile */ "b"](JSON.stringify(k), passphrase);
    }).then(f => {
      const blob = new Blob([f], {
        type: 'text/plain;charset=us-ascii'
      });
      file_saver__WEBPACK_IMPORTED_MODULE_1___default.a.saveAs(blob, 'element-keys.txt');
      this.props.onFinished(true);
    }).catch(e => {
      matrix_js_sdk_src_logger__WEBPACK_IMPORTED_MODULE_3__[/* logger */ "a"].error("Error exporting e2e keys:", e);
  ...
  render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_views_dialogs_BaseDialog__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
      className: "mx_exportE2eKeysDialog",
      onFinished: this.props.onFinished,
      title: Object(_languageHandler__WEBPACK_IMPORTED_MODULE_4__[/* _t */ "a"])("Export room keys")
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", null, Object(_languageHandler__WEBPACK_IMPORTED_MODULE_4__[/* _t */ "a"])('This process allows you to export the keys for messages ' + 'you have received in encrypted rooms to a local file. You ' + 'will then be able to import the file into another Matrix ' + 'client in the future, so that client will also be able to ' + 'decrypt these messages.')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", null, Object(_languageHandler__WEBPACK_IMPORTED_MODULE_4__[/* _t */ "a"])('The exported file will allow anyone who can read it to decrypt ' + 'any encrypted messages that you can see, so you should be ' + 'careful to keep it secure. To help with this, you should enter ' + 'a passphrase below, which will be used to encrypt the exported ' + 'data. It will only be possible to import the data by using the ' + 'same passphrase.')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: "error"
    }, this.state.errStr), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      htmlFor: "passphrase1"
    }, Object(_languageHandler__WEBPACK_IMPORTED_MODULE_4__[/* _t */ "a"])("Enter passphrase"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      htmlFor: "passphrase2"
    }, Object(_languageHandler__WEBPACK_IMPORTED_MODULE_4__[/* _t */ "a"])("Confirm passphrase"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: "mx_E2eKeysDialog_inputCell"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("input", {
      ...
      type: "submit",
      value: Object(_languageHandler__WEBPACK_IMPORTED_MODULE_4__[/* _t */ "a"])('Export'),
      disabled: disableForm
